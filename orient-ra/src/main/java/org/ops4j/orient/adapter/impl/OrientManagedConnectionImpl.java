...
public class OrientManagedConnectionImpl implements ManagedConnection, Closeable {
  ...
  private String engine;
	...
	private OException commitException;
  ...
  class OrientLocalTransaction implements LocalTransaction {
    ...
    public void commit() throws ResourceException {
      ...
      try {
        ...
        transactionOperationException = t;
      }
			fireConnectionEvent(LOCAL_TRANSACTION_COMMITTED, transactionOperationException);
    }
  ...
  private void fireConnectionEvent(int event, Exception ex) {
	  ConnectionEvent connectionEvent = (ex != null ? new ConnectionEvent(this, event, ex) : new ConnectionEvent(this, event));
